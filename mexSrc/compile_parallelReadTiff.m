...
elseif ismac
    ...
    if computer == "MACI64"
        ...
        system('install_name_tool -change /opt/homebrew/opt/gcc@13/lib/gcc/13/libgomp.1.dylib @loader_path/libgomp.1.dylib ../mac/parallelReadTiff.mexmaca64');
        ...
        system('install_name_tool -change @rpath/libcppTiff.dylib @loader_path/libcppTiff.dylib ../mac/parallelReadTiff.mexmaca64');
