...
if isunix && ~ismac
    ...
    if debug
        ...
        mex -outdir ../linux -output parallelReadTiff.mexa64 -v CXXOPTIMFLAGS="-DNDEBUG -O3" LDOPTIMFLAGS="-Wl',-rpath='''$ORIGIN'''' -O3 -DNDEBUG" CXXFLAGS='$CXXFLAGS -fopenmp -O3' LDFLAGS='$LDFLAGS -fopenmp -O3' -I'/global/home/groups/software/sl-7.x86_64/modules/libtiff/4.5.1/include' -L'/global/home/groups/software/sl-7.x86_64/modules/libtiff/4.5.1/lib64' -lstdc++ -ltiff parallelreadtiffmex.cpp ../src/helperfunctions.cpp ../src/parallelreadtiff.cpp
    end
    ...
    system(['patchelf --replace-needed libstdc++.so.6 libstdc++.so.6.0.30 ' releaseFolder '/parallelReadTiff.mexa64']);
elseif ismac
