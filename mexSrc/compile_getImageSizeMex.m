...
if isunix && ~ismac
    ...
    if debug
        ...
        mex -outdir ../linux -output getImageSizeMex.mexa64 -v CXXOPTIMFLAGS="-DNDEBUG -O3" LDOPTIMFLAGS="-Wl',-rpath='''$ORIGIN'''' -O3 -DNDEBUG" CXXFLAGS='$CXXFLAGS -fopenmp -O3' LDFLAGS='$LDFLAGS -fopenmp -O3' -I'/global/home/groups/software/sl-7.x86_64/modules/libtiff/4.5.1/include' -L'/global/home/groups/software/sl-7.x86_64/modules/libtiff/4.5.1/lib64' -lstdc++ -ltiff getimagesizemex.cpp ../src/helperfunctions.cpp
    end
...
elseif ispc
    ...
    mex  -outdir ../windows -output getImageSizeMex.mexw64 -v CXX="C:/mingw64/bin/g++" -v CXXOPTIMFLAGS="-DNDEBUG -O3" LDOPTIMFLAGS="-Wl',-rpath='''$ORIGIN'''' -O3 -DNDEBUG" CXXFLAGS='$CXXFLAGS -fopenmp -O3' LDFLAGS='$LDFLAGS -fopenmp -O3' -I'C:/Program Files (x86)/tiff/include' -L'C:\Program Files (x86)\tiff\lib' -ltiff.dll getimagesizemex.cpp ../src/helperfunctions.cpp
end
